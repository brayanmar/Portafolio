...
type Persona = Array <{
  ...
  contacto:Array<{ linke: string, Git: string, numero: string, correo: string, calen: string }>
...
export class FooComponent {
  personaje: Persona = [{
    ...
    contacto: [{linke: "https://www.linkedin.com/in/brayan-andres-ramirez-martinez-380891263", Git:"https://github.com/brayanmar", numero: "+ 57 318-547-1138", correo: "brianbrian216@gmail.com", calen: "https://calendly.com/brayanmar/entrevistas-programador-full-stack-developer" }]
      }];
}
